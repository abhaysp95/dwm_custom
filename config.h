...
static const char *fonts[]          	= { "UbuntuMono Nerd Font Mono:style=Regular:size=9" };
...
static Key keys[] = {
	...
	/** volume */
	{ MODKEY           , XK_minus , spawn , {.v = (const char *[]) { "notifyChanges.sh" , "--volume" , "--down" , "5"  } } } ,
	{ MODKEY|ShiftMask , XK_minus , spawn , {.v = (const char *[]) { "notifyChanges.sh" , "--volume" , "--down" , "15" } } } ,
	{ MODKEY           , XK_equal , spawn , {.v = (const char *[]) { "notifyChanges.sh" , "--volume" , "--up"   , "5"  } } } ,
	{ MODKEY|ShiftMask , XK_equal , spawn , {.v = (const char *[]) { "notifyChanges.sh" , "--volume" , "--up"   , "15" } } } ,
	...
	/** brightness */
	{ MODKEY|ControlMask,		XK_minus,		spawn,		{.v = (const char *[]) { "notifyChanges.sh", "--brightness", "--down", "5" } } },
	{ MODKEY|ControlMask,		XK_equal,		spawn,		{.v = (const char *[]) { "notifyChanges.sh", "--brightness", "--up",   "5" } } },

	/** call some other custom scripts */
	{ MODKEY|ControlMask,		XK_p,			spawn,		{.v = (const char *[]) { "libdmenu", "pdfs"   } } } ,
	{ MODKEY|ControlMask,		XK_v,			spawn,		{.v = (const char *[]) { "libdmenu", "videos" } } } ,
	{ MODKEY|ControlMask,		XK_m,			spawn,		{.v = (const char *[]) { "libdmenu", "man"    } } } ,
	{ MODKEY|ControlMask,		XK_y,			spawn,		{.v = (const char *[]) { "ympv.sh"            } } } ,
	...
	{ MODKEY             , XK_Print , spawn , {.v = (const char *[]) { "sshots", "--full"  } } } ,
	{ MODKEY|ShiftMask   , XK_Print , spawn , {.v = (const char *[]) { "sshots", "--dmenu" } } } ,
	{ MODKEY|ControlMask , XK_Print , spawn , {.v = (const char *[]) { "recscreen"         } } } ,

	/** easy bookmark bindings */
	{ MODKEY             , XK_Insert    , spawn , {.v = (const char *[]) { "easybkmrk"            } } } ,
	{ MODKEY|ShiftMask   , XK_Insert    , spawn , {.v = (const char *[]) { "easybkmrk", "--title" } } } ,
	{ MODKEY|ControlMask , XK_backslash , spawn , {.v = (const char *[]) { "easybkmrk", "--get"   } } } ,
	{ MODKEY|ShiftMask   , XK_Delete    , spawn , {.v = (const char *[]) { "easybkmrk", "--del"   } } } ,
